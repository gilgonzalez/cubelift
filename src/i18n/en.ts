export const t = {
  ...
  home: {
    ...
    hero_description:
      "Accessibility, efficiency and design in a compact residential lift that installs without complex works.",
    section_1_title:
      "A compact domestic lift, elegant and designed for real spaces",
    section_1_paragraph_1:
      "The square pneumatic lift of Cubelifts is designed to easily integrate into European homes, adapting to conventional holes thanks to its rectangular shape. Its optimized architecture allows for quick installation, without the need for a workshop or machine room, maintaining a high level of security and energy efficiency.",
    section_1_paragraph_2:
      "Unlike traditional elevators, Cubelifts uses air compression technology to move smoothly and stably, offering a modern, durable, and maintenance-reduced alternative. Its discreet and minimalist design makes it a functional element that improves comfort and accessibility in the home.",
    section_2_title: "How does a Cubelifts lift look in your home?",
    section_2_description:
      "Our square pneumatic lift seamlessly integrates into various home types, from modern designs to traditional spaces. Explore a selection of images and renders that showcase its minimalist aesthetic and adaptability.",
    section_3_title: "A practical, secure and prepared solution for the future",
    section_3_description:
      "Cubelifts represents a new generation of residential lifts. Clean technology, quick installation and an optimized structure that allows for a practical and secure solution. A product conceived to integrate into daily life without complications and adapted to European quality and security standards.",
  },
  product: {
    hero_title: "The compact pneumatic lift for modern homes",
    hero_description:
      "An efficient, elegant residential lift designed to blend into real spaces within any type of home.",
    section_1_title:
      "A new generation of domestic lifts",
    section_1_paragraph_1:
      "CubeLift is a state-of-the-art residential lift that combines pneumatic technology with an optimised structural design and a compact format. Its configuration allows for quick and clean installation, without a pit or machine room, making it an ideal solution for single-family homes, renovations and new construction projects.",
    section_1_paragraph_2:
      "With its square design and minimalist lines, CubeLift fits easily into corridors, corners and conventional spaces. It offers comfort, accessibility and efficiency in an elegant, quiet home lift that is ready for today's lifestyle.",
    section_2_title: "Quick, clean and hassle-free installation",
    section_2_paragraph_1:
      "CubeLift is designed to offer maximum convenience both during use and installation. Thanks to its pneumatic system, it does not require major construction work or additional infrastructure.",
    section_3_title: "Security guaranteed in every journey",
    section_3_paragraph_1:
      "CubeLift incorporates redundant security systems, automatic braking and sensors that continuously monitor the movement of the cabin. The empty-function eliminates the risk of falls and ensures stable and reliable displacement.",
    section_3_paragraph_2:
      "In addition, CubeLift is designed according to applicable European security and accessibility standards, offering total tranquility in a domestic environment.",
    items: {
  ...
  advantages: {
    ...
    item_1: {
      ...
      description:
        "The lift is designed to fit into small spaces, with a minimalist and modern aesthetic that enhances the home's functionality.",
    },
    item_2: {
      title: "Quick installation",
      description:
        "The lift is installed without the need for a workshop or machine room, saving time and effort.",
    },
    item_3: {
      title: "Optimized architecture",
      description:
        "The lift's optimized architecture allows for quick and efficient movement, with a high level of security and energy efficiency.",
    },
    item_4: {
      title: "Air compression technology",
      description:
        "The lift uses air compression technology to move smoothly and stably, offering a modern, durable, and maintenance-reduced alternative.",
    },
    item_5: {
      title: "Discreet and minimalist design",
      description:
        "The lift's discreet and minimalist design makes it a functional element that improves comfort and accessibility in the home.",
    },
    item_6: {
      title: "Esthetic modern and adaptable",
      description:
        "Lines clean, cabin luminous and customization options to fit in different interior styles.",
    },
  },
  specifications: {
    ...
    specification_1: {
      ...
      item_2:
        "External width options between 80–100 cm (depending on configuration)",
  ...
  footer: {
    ...
    description:
      "If you want to improve the mobility in your home with a compact, safe and fast installation lift, Cubelifts is the perfect solution. Request a custom proposal and discover how to integrate it into your home.",
  },
  form:{
    name: "Name",
    surname: "Surname",
